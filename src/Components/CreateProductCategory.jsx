...
export default function CreateProductCategory() {
  ...
  return (
    <div className="min-h-screen rounded-[24px] border-2 border-white bg-white/50 backdrop-blur-[16.5px] p-6">
      <form onSubmit={handleSubmit} className="p-8">
        <div className="grid grid-cols-2 items-center mb-8">
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className="w-96 p-3 bg-blue-50/50 rounded-lg"
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="bg-teal-500 text-white px-12 py-3 rounded-full text-xl hover:bg-teal-600 transition-colors"
          >
            Create
          </button>
        </div>
